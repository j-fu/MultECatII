...
\projectTitle{Multi Material Electorcatalysis (MultECat II)}
%%%%% PIs / Applicants
...
%\projectShortSummary{Modern multi-material electrocatalysis is crucial for
%  applications relevant for the energy transition. Thermodynamic modeling and numerical simulation
%  will help to increase their efficiency, scalability and reduce cost. We intend to extending the
%  results of the first project period towards non-equilibrium  thermodynamics.
%  }
  
 \projectShortSummary{Electrocatalysis is crucial for our future society and  sustainable economy. 
%applications relevant for the energy transition.
Thermodynamic modeling and numerical simulation
will help to increase their efficiency, scalability and reduce cost.
Results of MultECat will be extended to non-equilibrium, a large set of samples calculated, and data provided within the NFDI.}
...
A pioneering aspect for heterogeneous interfaces is the transition from surface patch labeling towards a description %of a multi-material electrode in terms of  
